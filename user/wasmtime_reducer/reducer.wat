(module $reducer.wasm
  ...
  (import "env" "access_buffer" (func $access_buffer (type 3)))
  ...
  (func $main (type 4) (param i32 i32) (result i32)
    ...
    local.get 4
    local.get 5
    i32.store offset=160000412
    local.get 4
    local.get 0
    i32.store offset=160000408
    local.get 4
    local.get 1
    i32.store offset=160000404
    local.get 4
    i32.load offset=160000404
    local.set 6
    local.get 6
    i32.load offset=4
    local.set 7
    ...
    local.get 4
    local.get 11
    i32.store offset=160000396
    local.get 4
    i32.load offset=160000400
    local.set 12
    local.get 4
    i32.load offset=160000396
    local.set 13
    local.get 4
    local.get 13
    ...
    local.get 4
    local.get 17
    i32.store offset=160000268
    local.get 4
    i32.load offset=160000396
    local.set 18
    local.get 4
    local.get 18
    i32.store offset=160000264
    i32.const 1343
    local.set 19
    i32.const 0
    local.set 20
    ...
    local.get 4
    local.get 21
    i32.store offset=160000260
    block  ;; label = @1
      block  ;; label = @2
        loop  ;; label = @3
          local.get 4
          i32.load offset=160000260
          local.set 22
          local.get 4
          i32.load offset=160000264
          local.set 23
          local.get 22
          local.set 24
          local.get 23
            ...
            block  ;; label = @5
              ...
              block  ;; label = @6
                block  ;; label = @7
                  ...
                  i32.add
                  i32.const 0
                  i64.load offset=4828 align=4
                  i64.store align=4
                  local.get 9
                  i32.const 0
                  i64.load offset=4820 align=4
  ...
  (func $internal_register_preopened_fd_unlocked (type 4) (param i32 i32) (result i32)
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        ...
        i32.const 0
        local.get 4
        i32.store offset=4884
        i32.const 0
        local.get 5
        i32.store offset=4876
        local.get 3
        call $free
      end
      block  ;; label = @2
  ...
  (func $vsscanf (type 1) (param i32 i32 i32) (result i32)
    ...
    global.set $__stack_pointer
    local.get 0)
  (func $string_read (type 1) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    local.get 0
    i32.load offset=68
    local.set 3
